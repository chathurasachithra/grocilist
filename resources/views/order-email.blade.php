...
<!-- HEADER -->
<table class="head-wrap" bgcolor="#0c9b5b">
    <tr>
        <td></td>
        <td class="header container">

            <div class="content">
                <table bgcolor="#0c9b5b">
                    <tr>
                        <td align="right">
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <h4>Your Order 0000{{ $order['id'] }}</h4>
                            <p>Thank you for placing your order with grocilist. This email is to confirm your order has been placed successfully, and will be processed & deliver to you soon.</p>
